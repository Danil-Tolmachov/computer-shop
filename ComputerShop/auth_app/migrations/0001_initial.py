    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resents', models.CharField(blank=True, max_length=200)),
                ('notifications', models.JSONField(blank=True, default=dict)),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now)),
                ('is_active', models.BooleanField(default=True)),
                ('cart', models.ManyToManyField(blank=True, related_name='user', to='cart.productitem')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('orders', models.ManyToManyField(blank=True, related_name='shopuser', to='cart.order')),
            ...
            managers=[
                ('objects', auth_app.models.ShopUserManager()),
            ],
        ),
    ]
