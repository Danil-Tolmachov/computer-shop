...
from auth_app.views import Activation, ChangeEmail, ChangeUserPassword, LoginUser, CreateUser, ChangeUser, logout_user, Account, ForgotUserPassword
...
urlpatterns = [
    ...
    # Register and change user pathes
